...
public class DalGenerator {
    ...
    //基本包名
    private static String basePackage = "com.mineway.study.service.entity";
    //作者
    private static String authorName = "kirck007";
    //要生成的表名
    private static String[] tables = {"t_rz_rule"};
    //table前缀
    ...
    private static String url = "jdbc:mysql://47.93.124.86:3306/study?serverTimezone=UTC&characterEncoding=utf-8";
